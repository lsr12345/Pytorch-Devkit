...
from model.utils.ops import hsigmoid, hswish
...
if __name__ == '__main__':
    ...
    mobilenetv3_l = MobileNetV3_Large_().to(device)
    summary(mobilenetv3_l, (3, 256, 256))

    mobilenetv3_s = MobileNetV3_Small_().to(device)
    summary(mobilenetv3_s, (3, 256, 256))
